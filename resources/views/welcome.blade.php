...
<head>
    ...
    <title>Acceuil | AWD SARL</title>
    <link rel="icon" href="{{ asset('storage/logo AWD.png') }}" type="image/png">
...
<body>
            ...
            <nav class="relative max-w-7xl w-full flex flex-wrap lg:grid lg:grid-cols-12 basis-full items-center px-4 md:px-6 lg:px-8 mx-auto">
                <div class="lg:col-span-2 flex items-center">
                    ...
                    <a class="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80" href="../" aria-label="Preline">
                        <img src="{{ asset('storage/logo AWD2.png') }}" alt="Logo" class="w-24" />
                    </a>
                    <!-- End Logo -->
    ...
    <section id="hero" class="font-poppins">
        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-3xl lg:text-4xl lg:leading-tight dark:text-white"><span class="text-orange-theme"> L'innovation numérique </span> au service du développement africain </h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400"> Des solutions logicielles conçues par des experts pour bâtir un avenir digital inclusif et performant.</p>

                    <!-- Buttons -->
                    <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                        <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-orange-theme text-white hover:bg-orange-600 focus:outline-hidden focus:bg-orange-600 disabled:opacity-50 disabled:pointer-events-none" href="#">
                            Découvrir nos services
                            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="m9 18 6-6-6-6" />
                            </svg>
                        </a>
                        <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-blue-theme bg-white text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#">
                            Nous contacter
                        </a>
                    </div>
                    <!-- End Buttons -->
                ...
                <div class="relative ms-4 pb-8">
                    <img class="w-full" src="{{ asset('storage/imagehero.png') }}" alt="Hero Image" />
                </div>
                <!-- End Col -->
            </div>
            <!-- End Grid -->
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-12">
                ...
                <div class="text-center">
                    <div class="flex justify-center items-center size-12 bg-blue-50 border border-orange-200 rounded-full mx-auto dark:bg-neutral-800 dark:border-neutral-700">
                        ...
                        <svg class="shrink-0 size-5 text-orange-theme dark:text-neutral-400" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                            <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3">
                                <path d="M36.91 3.486c2.546.223 4.45 2.212 4.627 4.762c.225 3.227.463 8.38.463 15.752s-.238 12.525-.463 15.752c-.177 2.55-2.081 4.539-4.627 4.762C34.12 44.76 29.885 45 24 45s-10.121-.24-12.91-.486c-2.546-.223-4.45-2.212-4.627-4.762C6.238 36.525 6 31.372 6 24s.238-12.525.463-15.752c.177-2.55 2.081-4.539 4.627-4.762C13.88 3.24 18.115 3 24 3s10.121.24 12.91.486M42 24H6" />
                                <path d="M41.45 40.418c-4.077-4.07-6.887-6.31-8.644-7.521c-1.42-.98-3.172-.82-4.495.29c-1.543 1.293-4.03 3.531-7.811 7.313a183 183 0 0 0-4.217 4.345M18 33a3 3 0 1 1-6 0a3 3 0 0 1 6 0m-5-16h22m-22-6.5h12" />
                            </g>
                        </svg>
                    </div>
                    <div class="mt-3">
                ...
                <div class="text-center">
                    <div class="flex justify-center items-center size-12 bg-blue-50 border border-orange-200 rounded-full mx-auto dark:bg-neutral-800 dark:border-neutral-700">
                        ...
                        <svg class="shrink-0 size-5 text-orange-theme dark:text-neutral-400" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                            <path fill="currentColor" d="M27.425 12.19h1.53v7.62h-1.53Zm-1.52 7.62h1.52v1.52h-1.52Zm0-9.15h1.52v1.53h-1.52Zm-1.53 10.67h1.53v1.53h-1.53Zm0-12.19h1.53v1.52h-1.53Zm-1.52 19.81H4.575V3.05h4.57v1.52h9.14V3.05h4.57v3.04h1.52V1.52h-1.52V0H4.575v1.52h-1.53v28.95h1.53V32h18.28v-1.53h1.52V25.9h-1.52Zm-9.14-27.43h3.05v1.53h-3.05Zm-3.05 0h1.52v1.53h-1.52Z" />
                            <path fill="currentColor" d="M22.855 16.76h1.52v1.52h-1.52Zm-6.09 6.1h7.61v1.52h-7.61Zm1.52-7.62h4.57v1.52h-4.57Zm0 3.04v1.53h1.52v1.52h1.53v-1.52h1.52v-1.53zm4.57-4.57v-1.52h-1.52v-1.53h-1.53v1.53h-1.52v1.52zm-6.09-6.09h7.61v1.52h-7.61Zm0 6.09h1.52v1.53h-1.52Zm-1.53 7.62h1.53v1.53h-1.53Zm0-12.19h1.53v1.52h-1.53Zm-1.52 10.67h1.52v1.52h-1.52Zm0-9.15h1.52v1.53h-1.52Zm-1.53 1.53h1.53v7.62h-1.53Z" />
                        </svg>
                    </div>
                    <div class="mt-3">
                ...
                <div class="text-center">
                    <div class="flex justify-center items-center size-12 bg-blue-50 border border-orange-200 rounded-full mx-auto dark:bg-neutral-800 dark:border-neutral-700">
                        <svg class="shrink-0 size-5 text-orange-theme dark:text-neutral-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <div class="grid gap-12">
                    ...
                    <div class="space-y-6 lg:space-y-10">
                        ...
                        <div class="flex gap-x-5 sm:gap-x-8">
                            ...
                            <svg class="shrink-0 mt-2 size-6 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="256" height="256" viewBox="0 0 256 256">
                        ...
                        <div class="flex gap-x-5 sm:gap-x-8">
                            ...
                            <svg class="shrink-0 mt-2 size-6 text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-8">
                    <div class="col-span-full lg:col-span-1">
                        <a class="flex-none text-xl font-semibold text-white focus:outline-hidden focus:opacity-80" href="../" aria-label="Brand">
                            <img src="{{ asset('storage/logo AWD2.png') }}" alt="Logo" />
                        </a>
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="mt-3 grid space-y-3">
                            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-blue-theme focus:outline-hidden focus:text-white focus:bg-blue-theme dark:text-neutral-400 dark:hover:bg-blue-theme dark:focus:bg-blue-theme" href="#">AWDPAY (Fintech)
                                </a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-blue-theme focus:text-white  focus:outline-hidden focus:bg-blue-theme dark:text-neutral-400 dark:hover:bg-blue-theme dark:focus:bg-blue-theme" href="#">Développement logiciel
                                </a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-blue-theme focus:text-white  focus:outline-hidden focus:bg-blue-theme dark:text-neutral-400 dark:hover:bg-blue-theme dark:focus:bg-blue-theme" href="#">Design digital</a></p>
                        </div>
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="mt-3 grid space-y-3">
                            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-blue-theme focus:text-white  focus:outline-hidden focus:bg-blue-theme dark:text-neutral-400 dark:hover:bg-blue-theme dark:focus:bg-blue-theme " href="#">À propos de nous</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-blue-theme focus:text-white  focus:outline-hidden focus:bg-blue-theme dark:text-neutral-400 dark:hover:bg-blue-theme dark:focus:bg-blue-theme" href="#">Solutions par pays</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-blue-theme focus:text-white  focus:outline-hidden focus:bg-blue-theme dark:text-neutral-400 dark:hover:bg-blue-theme dark:focus:bg-blue-theme" href="#">Faire un devis en -24h / Contact
                                </a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-blue-theme focus:text-white  focus:outline-hidden focus:bg-blue-theme dark:text-neutral-400 dark:hover:bg-blue-theme dark:focus:bg-blue-theme" href="#">Témoignages & études de cas
                                </a></p>
                        </div>
                    </div>
                    <!-- End Col -->
    ...
    <!-- Whatsapp Button  -->
    <a href="https://wa.me/237656849690"
        target="_blank"
        class="fixed bottom-6 right-6 z-50 bg-green-400 hover:bg-green-500 text-white p-4 rounded-full shadow-lg transition">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 256 258">
            <defs>
